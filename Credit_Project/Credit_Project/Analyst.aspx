<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Analyst.aspx.cs" Inherits="Credit_Project.Analyst" %>
...
<div class="wrapper">
    ...
    <div class="content">
           ...
           <table class="auto-style8">
               <tr>
                   <td class="auto-style9" colspan="2"><strong>Analyst</strong> <strong>Name</strong> <strong>Control Panel Page</strong></td>
               </tr>
               <tr>
                   <td class="auto-style9" colspan="2">&nbsp;</td>
               </tr>
               <tr>
                   <td class="auto-style10"><span style="color: #000066">Edit Analyst Name Section</span></td>
                   <td class="auto-style10">&nbsp;</td>
               </tr>
               <tr>
                   <td>
                       <asp:Label ID="Label1" runat="server" style="font-size: 16px; color: #000066" Text="Analyst Name"></asp:Label>
&nbsp;:
                       <asp:TextBox ID="TextBox1" runat="server" Height="21px" Width="200px" CausesValidation="True"></asp:TextBox>
                   &nbsp;
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Input Analyst Name" ForeColor="Red"></asp:RequiredFieldValidator>
                       <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
